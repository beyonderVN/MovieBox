...
public class MoviesRepository implements MoviesDataSource {
    ...
    @Inject
    public MoviesRepository(MoviesRemoteDataSource moviesRemoteDataSource, MoviesLocalDataSource moviesLocalDataSource) {
        mCompetitionsRemoteDataSource = moviesRemoteDataSource;
        mCompetitionsLocalDataSource = moviesLocalDataSource;
    }
